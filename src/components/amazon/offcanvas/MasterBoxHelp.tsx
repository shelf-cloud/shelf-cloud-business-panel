      ...
      <OffcanvasBody>
        <div className='flex flex-col'>
          ...
          <div className='text-[11.2px]'>
            ...
            <p className='text-[13px] font-semibold'>Step 2 - Upload Template File and Assign Fulfillment</p>
            <ul>
            ...
            <p className='text-[13px] font-semibold'>Step 3 - Fulfillment Workflow</p>
            <ul>
