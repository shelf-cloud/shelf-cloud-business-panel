        ...
        <div className='tw:text-[11.2px] tw:flex tw:flex-col tw:gap-2 tw:py-2'>
          {orderItems
            ...
            .map((item) => {
              ...
              return (
                <div key={`${item.poId}-${item.inventoryId}`} className='tw:flex tw:flex-row tw:justify-between tw:items-center tw:gap-4 tw:border tw:rounded tw:py-2 tw:px-2'>
                  <div className='tw:text-center'>
                    <div className='tw:flex tw:flex-row tw:justify-start tw:items-center tw:gap-2'>
                      ...
                      <div className='tw:text-left'>
                        ...
                        {isReceivingFromPo && <p className='tw:text-nowrap tw:m-0 tw:text-[var(--bs-secondary-color)]'>PO: {item.poNumber}</p>}
                        <p className='tw:text-nowrap tw:m-0'>Receiving: {item.quantity}</p>
                      </div>
                    </div>
                  </div>
                  <Badge
