                  ...
                  <table className='w-full text-nowrap mb-0 [&_td]:px-2 [&_td]:py-1'>
                    <tbody>
                      ...
                      <tr className='border-b border-[color:var(--border)]' onClick={() => setShowPPCCosts(!showPPCCosts)} style={{ cursor: 'pointer' }}>
                        ...
                        <td className={'font-normal text-right text-black'}>-{FormatCurrency(state.currentRegion, data.totalPPCCosts)}</td>
                      </tr>
                      <tr>
                        <td className='p-0' colSpan={2}>
                      ...
                      <tr className='border-b border-[color:var(--border)]' onClick={() => setShowCogs(!showCogs)} style={{ cursor: 'pointer' }}>
                        ...
                        <td className={'font-normal text-right text-black'}>-{FormatCurrency(state.currentRegion, data.totalCogs)}</td>
                      </tr>
                      <tr>
                        <td className='p-0' colSpan={2}>
                      ...
                      <tr>
                        ...
                        <td className={'font-bold text-right text-destructive text-[16.25px]'}>-{FormatCurrency(state.currentRegion, data.totalExpenses)}</td>
                      </tr>
                      <tr className='border-t border-[color:var(--foreground)]'>
                        <td className='font-bold text-[16.25px]'>Net Profit</td>
                        <td className={'font-bold text-[16.25px] text-right ' + (data.grossRevenue - data.totalExpenses >= 0 ? 'text-primary' : 'text-destructive')}>
