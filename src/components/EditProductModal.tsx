      ...
      <ModalBody>
        {!loading && (
          <Form onSubmit={handleAddProduct}>
            <Row>
              <h5 className='text-[16.25px] m-4 font-bold'>Product Details</h5>
              ...
              <h5 className='text-[13px] mb-4 text-[var(--bs-secondary-color)]'>*You must complete all required fields or you will not be able to create your product.</h5>
              <Col md={12}>
