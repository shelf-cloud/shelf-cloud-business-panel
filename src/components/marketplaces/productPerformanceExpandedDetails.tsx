                ...
                <table className='tw:w-full tw:text-nowrap tw:mb-0 tw:[&_td]:px-2 tw:[&_td]:py-1'>
                  <tbody>
                                    ...
                                    <Collapse className='tw:ps-4 tw:pe-1 tw:py-0 tw:w-full' isOpen={showAmazonFbaFees}>
                                      ...
                                      {market.fees.FBAPerUnitFulfillmentFee! !== 0 && (
                                        <div className='tw:border-b tw:border-[color:var(--border)] tw:py-1 tw:w-full tw:flex tw:flex-row tw:justify-between tw:items-center'>
                                          ...
                                          <span className={'tw:font-normal tw:text-right tw:text-[color:var(--bs-secondary-color)] tw:text-[11.2px]'}>{FormatCurrency(state.currentRegion, market.fees.FBAPerUnitFulfillmentFee!)}</span>
                                        </div>
                                      )}
                    ...
                    <tr className='tw:border-b tw:border-[color:var(--border)]' onClick={() => setShowPPCCosts(!showPPCCosts)} style={{ cursor: 'pointer' }}>
                      ...
                      <td className={'tw:font-normal tw:text-right tw:text-black'}>{FormatCurrency(state.currentRegion, totalPPCCosts)}</td>
                    </tr>
                    <tr>
                      <td className='tw:p-0' colSpan={2}>
                    ...
                    <tr className='tw:border-b tw:border-[color:var(--border)]' onClick={() => setShowCogs(!showCogs)} style={{ cursor: 'pointer' }}>
                      ...
                      <td className={'tw:font-normal tw:text-right tw:text-black'}>{FormatCurrency(state.currentRegion, totalCogs)}</td>
                    </tr>
                    <tr>
                      <td className='tw:p-0' colSpan={2}>
                    ...
                    <tr>
                      ...
                      <td className={cn('tw:font-bold tw:text-right tw:text-[16.25px]', totalExpenses >= 0 ? 'tw:text-destructive' : 'tw:text-primary')}>{FormatCurrency(state.currentRegion, totalExpenses)}</td>
                    </tr>
                    <tr className='tw:border-t tw:border-[color:var(--foreground)]'>
                      <td className='tw:font-bold tw:text-[16.25px]'>Net Profit</td>
                      <td className={'tw:font-bold tw:text-[16.25px] tw:text-right ' + (data.grossRevenue - totalExpenses >= 0 ? 'tw:text-primary' : 'tw:text-destructive')}>
