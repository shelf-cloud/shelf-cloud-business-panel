...
const FS_TO_TW: Record<string, string> = {
  'tw:text-[22.75px]': 'tw:text-[22.75px]',
  'tw:text-[19.5px]': 'tw:text-[19.5px]',
  'tw:text-[16.25px]': 'tw:text-[16.25px]',
  'tw:text-[13px]': 'tw:text-[13px]',
  'tw:text-[11.2px]': 'tw:text-[11.2px]',
}

const CopyTextToClipboard = ({ text, label, fontSize = 'tw:text-[13px]', className, title }: Props) => {
