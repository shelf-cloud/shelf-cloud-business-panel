  ...
  return (
    <Label
      ...
      className={cn(
        ...
        "tw:has-[>[data-slot=field]]:w-full tw:has-[>[data-slot=field]]:flex-col tw:has-[>[data-slot=field]]:rounded-md tw:has-[>[data-slot=field]]:border tw:has-[>[data-slot=field]]:border-border tw:has-[>[data-slot=field]]:bg-card tw:[&>*]:data-[slot=field]:p-4",
        "tw:has-data-[state=checked]:border-primary tw:has-data-[state=checked]:bg-primary/5 tw:dark:has-data-[state=checked]:bg-primary/10",
        className
      )}
      {...props}
    />
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "tw:text-sm tw:leading-normal tw:font-normal tw:text-muted-foreground tw:group-has-[[data-orientation=horizontal]]/field:text-balance",
