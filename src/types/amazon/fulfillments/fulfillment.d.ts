export interface InboundPlan {
  ...
  shipDate: string
  sameShippingMode: boolean
  shippingMode: 'SPD' | 'LTL'
  sameShippingCarrier: 'amazon' | 'non-amazon'
  finalShipmentsSelected: FinalShipmentSelected[]
...
export interface FinalShipmentSelected {
  shipmentId: string
  shippingMode: string
...
export interface TransportationOptions {
  [placementOptionId: string]: { [shipmentId: string]: TransportationOption[] }
}

export interface TransportationOptionShipment {
  [shipmentId: string]: TransportationOption[]
}
...
export interface DeliveryWindowsOptions {
  [placementOptionId: string]: { [shipmentId: string]: DeliveryWindowOption[] }
}
