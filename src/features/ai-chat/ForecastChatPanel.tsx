...
import { AlertTriangle, CalendarClock, Clock3, ShieldAlert } from 'lucide-react'
...
const ForecastChatPanel = ({ businessId, region, chatSessionKey, modelNumber, product, selectedForecast, urgencyThresholds }: Props) => {
