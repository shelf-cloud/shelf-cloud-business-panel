          ...
          <Container fluid>
            <Row className='tw:flex tw:flex-col tw:justify-center tw:items-end tw:gap-2 tw:mb-2 tw:md:flex-row tw:md:justify-end tw:md:items-center tw:px-3'>
              <div className='tw:flex tw:flex-col tw:gap-2 tw:justify-between tw:items-center tw:p-0 tw:lg:flex-row'>
                <div className='tw:flex tw:flex-wrap tw:justify-start tw:items-end tw:gap-2 tw:w-full'>
                  <button
                    className={
                      'tw:inline-flex tw:h-9 tw:items-center tw:gap-1 tw:rounded-md tw:px-3 tw:text-[11.2px] tw:font-semibold tw:whitespace-nowrap ' +
                      (filters === 'true' ? 'tw:bg-info tw:text-info-foreground' : 'tw:bg-white tw:border tw:border-[#E1E3E5] tw:text-foreground')
                    }
                    type='button'
                    aria-expanded='false'
                  ...
                  />
                  <Button color='info' className='tw:text-[11.2px]' onClick={() => setsummaryModal({ show: true })}>
                    PP Summary
                  </Button>
                </div>
            ...
            <Card>
              <CardBody>
                {loadingData ? (
                  <div>
                    <p className='tw:font-bold tw:text-[26px]'>Product Performance</p>
