...
const getReportList: NextApiHandler = async (request, response) => {
  ...
  axios
    .get(`${process.env.SHELFCLOUD_SERVER_URL}/api/reports/getReportList?region=${request.query.region}&businessId=${request.query.businessId}`, {
      headers: {
