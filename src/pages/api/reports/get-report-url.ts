...
const getReportUrl: NextApiHandler = async (request, response) => {
  ...
  axios
    .get(`${process.env.SHELFCLOUD_SERVER_URL}/api/reports/getReportUrl?reportFileName=${request.query.reportFileName}`, {
      headers: {
