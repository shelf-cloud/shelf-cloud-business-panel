...
const getDeductions: NextApiHandler = async (request, response) => {
  ...
  let url = `${process.env.API_DOMAIN_SERVICES}/${request.query.region}/api/commerceHub/getDeductions.php?businessId=${request.query.businessId}&offset=${request.query.offset}&limit=${request.query.limit}`
