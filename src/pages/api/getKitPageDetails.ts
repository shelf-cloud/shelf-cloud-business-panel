...
const getKitPageDetails: NextApiHandler = async (request, response) => {
    ...
    await axios(`${process.env.API_DOMAIN_SERVICES}/${request.query.region}/api/getKitPageDetails.php?inventoryId=${request.query.inventoryId}&businessId=${request.query.businessId}`)
...
export default getKitPageDetails