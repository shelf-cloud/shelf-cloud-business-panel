...
const unMapListingToSku: NextApiHandler = async (request, response) => {
    ...
    axios
        .patch(`${process.env.SHELFCLOUD_SERVER_URL}/amazon/listings/unMapListingToSku/${request.query.region}/${request.query.businessId}`, {
        ...
        .then(async ({ data }) => {
            ...
            axios.post(`${process.env.API_DOMAIN_SERVICES}/${request.query.region}/api/products/unMapListingToSku.php?businessId=${request.query.businessId}`, {
                listingId: request.body.listingId,
                listingSku: request.body.listingSku,
                shelfCloudSku: request.body.shelfCloudSku,
                shelfCloudSkuId: request.body.shelfCloudSkuId,
...
export default unMapListingToSku