...
const createManualInboundPlan: NextApiHandler = async (request, response) => {
    ...
    axios
        .post(`${process.env.SHELFCLOUD_SERVER_URL}/api/amz_workflow/createManualInboundPlan/${request.query.region}/${request.query.businessId}`, {
...
export default createManualInboundPlan
