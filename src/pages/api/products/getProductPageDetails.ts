...
const getProductDetails: NextApiHandler = async (request, response) => {
  ...
  await axios(
    `${process.env.API_DOMAIN_SERVICES}/${request.query.region}/api/products/getProductPageDetails.php?inventoryId=${request.query.inventoryId}&businessId=${request.query.businessId}`,
    {
      headers: {
