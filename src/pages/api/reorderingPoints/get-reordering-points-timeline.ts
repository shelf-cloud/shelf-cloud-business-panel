...
const getReorderingPointsTimeline: NextApiHandler = async (request, response) => {
  ...
  axios
    .get(
      `${process.env.SHELFCLOUD_SERVER_URL}/api/reorderingPoints/getReorderingPointsTimeline?region=${request.query.region}&businessId=${request.query.businessId}&sku=${request.query.sku}`,
      {
        headers: {
...
export default getReorderingPointsTimeline
