...
const getReorderingPointsProducts: NextApiHandler = async (request, response) => {
  ...
  axios
    .get(
      `${process.env.SHELFCLOUD_SERVER_URL}/api/reorderingPoints/delete_businesses_reorderingPoints_cache?region=${request.query.region}&businessId=${request.query.businessId}`,
      {
        headers: {
